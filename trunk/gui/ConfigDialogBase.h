...
protected:
    ...
    wxCheckBox* showTrayIconCheckbox;
    wxStaticText* label_9;
    wxCheckBox* showTaskBarIconCheckBox;
    ...
    wxStaticText* launchappHotKeyLabel;
    wxCheckBox* launchappHotKeyCtrlCheckBox;
    wxCheckBox* launchappHotKeyAltCheckBox;
    wxCheckBox* launchappHotKeyShiftCheckBox;
    wxComboBox* launchappHotKeyComboBox;
