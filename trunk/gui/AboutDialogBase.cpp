    ...
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE)
{
    ...
    label_2 = new wxStaticText(notebook_1_pane_1, wxID_ANY, wxT("Copyright (C) 2008 Laurent Cozic"));
...
void AboutDialogBase::do_layout()
{
    ...
    grid_sizer_1->Add(versionLabel, 0, wxEXPAND, 0);
    grid_sizer_1->Add(label_2, 0, wxBOTTOM, 10);
    ...
    sizer_5->Add(text_ctrl_1, 1, wxALL|wxEXPAND, 6);
