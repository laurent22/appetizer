...
const int SHELL32_ICON_INDEX_MY_COMPUTER = 15;//16;
const int SHELL32_ICON_INDEX_MY_NETWORK = 17;//18;
const int SHELL32_ICON_INDEX_CONTROL_PANEL = 21;//22;
const int SHELL32_ICON_INDEX_RECYCLE_BIN = 31;//32;
const int SHELL32_ICON_INDEX_DESKTOP = 34;//35;
const int SHELL32_ICON_INDEX_EXPLORER = 45;//46;
const int SHELL32_ICON_INDEX_SEARCH = 22;//23;
const int SHELL32_ICON_INDEX_MY_DOCUMENTS = 126;//126;
