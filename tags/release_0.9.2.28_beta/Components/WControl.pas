...
uses
  Controls, Classes, Messages, Dialogs, SysUtils, WContainer;
...
type
    ...
    pTop: Integer;
    pParentContainer: TWContainer;

    procedure SetButtonState(const Value: TPNGButtonState);
    procedure SetParentContainer(const value: TWContainer);
  ...
  published
    ...
    property ParentContainer: TWContainer read pParentContainer write SetParentContainer;
...
procedure TWComponent.SetParentContainer(const value: TWContainer);
begin
     //
end;
