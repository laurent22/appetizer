...
{
Modified by Laurent Cozic
- 05/08/08: Removed styling around button
- 05/08/08: Added a -2 offset on the image coordinate on the DOWN state, so
            that the state can be entirely defined by the PNG
}
...
begin
  ...
  Canvas.Draw(ImagePos.X + ImageOffsetX, ImagePos.Y + ImageOffsetY, Image);
