...
public:
	...
	static void LPCWSTR2CString( LPCWSTR strW, CStdString& str );
	// From unicode string to CStdString
	static void Unicode2CString( UNICODE_STRING* strU, CStdString& str );

	//////////////////////////////////////////////////////////////////////////////////
	// File name conversion functions

	static BOOL GetDeviceFileName( LPCTSTR, CStdString& );
	static BOOL GetFsFileName( LPCTSTR, CStdString& );
...
public:
  ...
  // MOD LC 24/11/2008: Changed buffer size so that NtQuerySystemInformation
  // doesn't fail when there are two many processes running simultaneously.
...
public:
	...
	static BOOL GetTypeToken( HANDLE, CStdString&, DWORD processId = GetCurrentProcessId() );
	static BOOL GetTypeFromTypeToken( LPCTSTR typeToken, WORD& type );
	static BOOL GetNameByType( HANDLE, WORD, CStdString& str, DWORD processId = GetCurrentProcessId());
	static BOOL GetName( HANDLE, CStdString&, DWORD processId = GetCurrentProcessId() );
	...
	static BOOL GetProcessPath( HANDLE h, CStdString& strPath, DWORD processId = GetCurrentProcessId());

	//File related functions
	static BOOL GetFileName( HANDLE, CStdString&, DWORD processId = GetCurrentProcessId() );
