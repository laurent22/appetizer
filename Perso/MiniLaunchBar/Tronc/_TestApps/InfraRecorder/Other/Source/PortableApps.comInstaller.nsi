...
!define NAME "InfraRecorder Portable"
!define SHORTNAME "InfraRecorderPortable"
!define VERSION "0.45.0.2"
!define FILENAME "InfraRecorder_Portable_0.45_Rev_2"
!define CHECKRUNNING "InfraRecorderPortable.exe"
!define CLOSENAME "InfraRecorder Portable"
...
Section "!App Portable (required)"
	...
	;=== delete old version settings file and delete no longer used files
	IfFileExists "$INSTDIR\App\AppInfo\appinfo.ini" "" PreInstallCodeEnd
		ReadINIStr $0 "$INSTDIR\App\AppInfo\appinfo.ini" "Version" "DisplayVersion"
		Delete "$INSTDIR\Data\settings\Settings.xml"
			StrCmp $0 "0.45" PreInstallCodeEnd
			StrCmp $0 "0.45 Rev 2" PreInstallCodeEnd
				Delete "$INSTDIR\App\InfraRecorder\cdrtools\isoinfo.exe"
				Delete "$INSTDIR\App\InfraRecorder\cdrtools\mkisofs.exe"
